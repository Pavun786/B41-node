...
// const MONGO_URL ='mongodb+srv://pavunkumar:pavun123@cluster0.mzriqqa.mongodb.net';
...
//     const movies =await client.db("users").collection("detail").find({}).toArray();//its look like mongodb command:db.detail.findOne({})
//     console.log(movies);
